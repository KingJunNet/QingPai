...
{
    public partial class AllocateTaskDialog : Form
    {
        ...
        public AllocateTaskDialog(GridView grid, int hand)
        {
            InitializeComponent();
            ...
            Hand = hand;
            Grid = grid;
            VIN = Grid.GetRowCellValue(Hand, "VIN").ToString().Trim();
        ...
        private void AllocateTaskDialog_Load(object sender, EventArgs e)
        {
            ...
            {
                dateEdit1.SetValue($"{DateTime.Now:yyyy/MM/dd HH:00}");
            }
            ...
            TaskcodeCombox.SetValue(Grid.GetRowCellValue(Hand, "VIN").ToString().Trim());
            
            SampleModel.SetValue(Grid.GetRowCellValue(Hand, "VehicleModel").ToString().Trim());
            Producer.SetValue(Grid.GetRowCellValue(Hand, "SampleProducter").ToString().Trim());
            YNDirect.SetValue(Grid.GetRowCellValue(Hand, "DirectInjection").ToString().Trim());
            ...
            EngineProduct.SetValue(Grid.GetRowCellValue(Hand, "EngineProducter").ToString().Trim());
            //Drivertype.SetValue(Grid.GetRowCellValue(Hand, "DriveFormTask").ToString().Trim());
            
            TransmissionType.SetValue(Grid.GetRowCellValue(Hand, "GearboxForm").ToString().Trim());
            FuelLabel.SetValue(Grid.GetRowCellValue(Hand, "FuelLabel").ToString().Trim());

            //SampleType2.SetValue(Grid.GetRowCellValue(Hand, "SampleType").ToString().Trim());
            SampleType.SetValue(Grid.GetRowCellValue(Hand, "SampleType").ToString().Trim());
            YNDirect2.SetValue(Grid.GetRowCellValue(Hand, "DirectInjection").ToString().Trim());
            PowerType2.SetValue(Grid.GetRowCellValue(Hand, "PowerType").ToString().Trim());
            FuelType.SetValue(Grid.GetRowCellValue(Hand, "FuelType").ToString().Trim());
                ...
                new SqlParameter("TestStartDate",dateEdit1.Value().ToString()),
                 ...
                 new SqlParameter("SampleModel",SampleModel.Text),
                  ...
                  new SqlParameter("MoneySure","否"),
                   ...
                   new SqlParameter("Drivertype",Grid.GetRowCellValue(Hand, "DriveFormParameter").ToString().Trim()),
                   new SqlParameter("Tirepressure",Grid.GetRowCellValue(Hand, "FetalPressureParameter").ToString().Trim()),
