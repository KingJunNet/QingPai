...
{
    public partial class ProjectEditDialog : BaseEditDialog
    {
        private readonly bool IsAllocateTask;

        private ProjectEditDialog():base()
        {
            InitializeComponent();
        }

        public ProjectEditDialog(bool authorityEdit, GridView theView, int theHand, List<DataField> fields, FormType Type1,
            bool isAllocateTask)
