    ...
    public static class Utils
    {
        ...
        public static bool ToDate(this object obj, out DateTime date)
        {
            ...
            if (DateTime.TryParse(s, out date))
                return true;
            if (DateTime.TryParseExact(s, new[] { "M/d/yy" },
              CultureInfo.InvariantCulture,
              DateTimeStyles.None, out date))
                return true;
            if (DateTime.TryParseExact(s, new[] { "MM/dd/yyyy" },
              CultureInfo.InvariantCulture,
              DateTimeStyles.None, out date))
                return true;
            if (DateTime.TryParseExact(s, new[] { "d/M/yy" },
              CultureInfo.InvariantCulture,
              DateTimeStyles.None, out date))
                return true;
            if (DateTime.TryParseExact(s, new[] { "dd-M月-yyyy" },
                ...
                DateTimeStyles.None, out date))
                return true;
            if (DateTime.TryParseExact(s, new[] { "d-M-yyyy" },
                CultureInfo.InvariantCulture,
                DateTimeStyles.None, out date))
                return true;
          
            if (DateTime.TryParseExact(s, new[] { "dd-MM-yyyy" },
                CultureInfo.InvariantCulture,
                DateTimeStyles.None, out date))
                return true;
            ...
            if (DateTime.TryParseExact(s, new[] { "yyyy-M-d" },
              ...
              DateTimeStyles.None, out date))
                return true;
            if (DateTime.TryParseExact(s, new[] { "yyyy年-MM月-dd日" },
               CultureInfo.InvariantCulture,
               DateTimeStyles.None, out date))
                return true;
            if (DateTime.TryParseExact(s, new[] { "yyyy年-M月-d日" },
              CultureInfo.InvariantCulture,
              DateTimeStyles.None, out date))
                return true;
